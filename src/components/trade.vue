  ...
  >
    <div class="containerCustom">
      <div class="headDiv" style>
        ...
        <v-btn class="drag headButtonRight" fab small dark color="red darken-1" @click="$store.state.options.style.trade.show=false">
          <v-icon medium>close</v-icon>
        </v-btn>
        <v-btn class="drag headButtonRight movebutton" fab small color="warning" @click="$store.state.options.style.trade.z=$store.getters.getHighestZ()">
      ...
      <div class="containerCustomBody">
        <v-layout column>
          <v-layout row wrap>
            <v-flex xs1>
              <v-checkbox primary label hide-details v-model="showVillage"></v-checkbox>
            </v-flex>
          ...
          <v-layout row wrap v-show="TradeTask.type=='Every x minutes'">
            <v-flex xs3>
              <v-text-field
                ...
                hide-details
                type="number"
                style="padding: 0; padding-left: 10px;" min="0"
              ></v-text-field>
            </v-flex>
          </v-layout>
          <v-layout row wrap>
            <v-flex xs3>
              <v-text-field
                ...
                hide-details
                type="number"
                style="padding: 0; padding-left: 10px;" min="100"
              ></v-text-field>
            </v-flex>
            <v-flex xs3>
              <v-text-field
        ...
        <v-layout row wrap v-show="TradeTask.type!='Send by %'" class="tradeicons">   
          <v-flex xs3>         
        ...
        <v-layout row wrap v-show="TradeTask.type=='Send by %'" class="tradeicons">
          ...
          :style="{ height: $store.state.options.style.trade.height-120+'px'}"
